      ...
      >
        ...
        >
          ...
          <div className="flex justify-center items-center">
            <Link href="/portfolio">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-text-primary to-text-secondary text-dark-primary font-semibold tracking-wider overflow-hidden rounded-lg border-2 border-text-primary hover:scale-105 hover:opacity-75 transform transition-all duration-300 shadow-lg hover:shadow-xl">
